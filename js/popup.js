...
async function run() {
    ...
    for (const key of ['fromDate', 'toDate', 'telegramId', 'kvtToken', 'usDataToken', 'alorToken', 'alorPortfolio', 'kvtFastVolumePrice', 'kvtFastVolumeSize', 'kvtSTIGFastVolSumBot', 'kvtSTIGFastVolSumRcktMon', 'compactStyle', 'showNullOperation', 'rcktMonConnect', 'kvtFastVolumePriceRound', 'IsShortTicker', 'alorStats', 'debug', 'alorTS']) {
